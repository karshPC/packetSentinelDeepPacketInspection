...
My core stack project which is a multi-threaded C++ Deep Packet Inspection engine that classifies network traffic (HTTPS/SNI, HTTP, DNS) from PCAP files and blocks it by app, domain, or IP using a load-balanced fast-path architecture.
